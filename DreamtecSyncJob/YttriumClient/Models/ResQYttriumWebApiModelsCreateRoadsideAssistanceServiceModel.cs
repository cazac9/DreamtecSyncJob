...
namespace DreamtecSyncJob.Yttrium.Models
{
    ...
    public partial class ResQYttriumWebApiModelsCreateRoadsideAssistanceServiceModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ResQYttriumWebApiModelsCreateRoadsideAssistanceServiceModel class.
        /// </summary>
        public ResQYttriumWebApiModelsCreateRoadsideAssistanceServiceModel() { }

        /// <summary>
        /// Initializes a new instance of the
        /// ResQYttriumWebApiModelsCreateRoadsideAssistanceServiceModel class.
        /// </summary>
        public ResQYttriumWebApiModelsCreateRoadsideAssistanceServiceModel(Guid caseId, Guid caseServiceDefinitionId, Guid creatorId, ResQYttriumWebApiModelsLocationModel requestLocation, ResQYttriumWebApiModelsContactPersonModel requestContactPerson, bool isServiceProviderOnScene, int? assistanceType = default(int?), string serviceProviderFirstName = default(string), string serviceProviderSurname = default(string), string serviceProviderContactInformation = default(string), Guid? serviceProviderId = default(Guid?), ResQYttriumWebApiModelsPaymentSpecificationModel paymentSpecificationModel = default(ResQYttriumWebApiModelsPaymentSpecificationModel), ResQYttriumWebApiModelsScheduleModel scheduleModel = default(ResQYttriumWebApiModelsScheduleModel), Guid? callId = default(Guid?), string cllientOrderNumber = default(string), string instruction = default(string))
        {
        ...
        /// <summary>
        /// The assistance type.  (this value is no longer being used -
        /// specify the correct CaseServiceDefinitionId to indicate the type
        /// of assistance)
        /// FlatBattery = 0,
        /// FuelRunPetrol = 1,
        /// FuelRunDiesel = 2,
        ...
        /// FlatTire = 4
        /// </summary>
        [JsonProperty(PropertyName = "AssistanceType")]
