...
namespace DreamtecSyncJob.Yttrium.Models
{
    ...
    public partial class ResQYttriumWebApiModelsCreateEmergencyAssistServiceModel
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ResQYttriumWebApiModelsCreateEmergencyAssistServiceModel class.
        /// </summary>
        public ResQYttriumWebApiModelsCreateEmergencyAssistServiceModel() { }

        /// <summary>
        /// Initializes a new instance of the
        /// ResQYttriumWebApiModelsCreateEmergencyAssistServiceModel class.
        /// </summary>
        public ResQYttriumWebApiModelsCreateEmergencyAssistServiceModel(Guid caseId, Guid caseServiceDefinitionId, Guid creatorId, ResQYttriumWebApiModelsLocationModel requestLocation, ResQYttriumWebApiModelsContactPersonModel requestContactPerson, bool isServiceProviderOnScene, string serviceProviderFirstName = default(string), string serviceProviderSurname = default(string), string serviceProviderContactInformation = default(string), Guid? serviceProviderId = default(Guid?), ResQYttriumWebApiModelsPaymentSpecificationModel paymentSpecificationModel = default(ResQYttriumWebApiModelsPaymentSpecificationModel), ResQYttriumWebApiModelsScheduleModel scheduleModel = default(ResQYttriumWebApiModelsScheduleModel), Guid? callId = default(Guid?), string cllientOrderNumber = default(string), string instruction = default(string))
        {
            CaseId = caseId;
