...
namespace DreamtecSyncJob.Acumatica
{
    ...
    /// <summary>
    /// Extension methods for ARQueryOperations.
    /// </summary>
    public static partial class ARQueryOperationsExtensions
    {
            /// <summary>
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> GetByKeysAsync(this IARQueryOperations operations, IList<string> ids, string select = default(string), string filter = default(string), string expand = default(string), string custom = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The values of the key fields of the record.
            /// </param>
            public static object DeleteByKeys(this IARQueryOperations operations, IList<string> ids)
            {
                return Task.Factory.StartNew(s => ((IARQueryOperations)s).DeleteByKeysAsync(ids), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> DeleteByKeysAsync(this IARQueryOperations operations, IList<string> ids, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// returned from the system.
            /// </param>
            public static object GetById(this IARQueryOperations operations, Guid id, string select = default(string), string filter = default(string), string expand = default(string), string custom = default(string))
            {
                return Task.Factory.StartNew(s => ((IARQueryOperations)s).GetByIdAsync(id, select, filter, expand, custom), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> GetByIdAsync(this IARQueryOperations operations, Guid id, string select = default(string), string filter = default(string), string expand = default(string), string custom = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// returned from the system.
            /// </param>
            public static object PutEntity(this IARQueryOperations operations, ARQuery entity, string select = default(string), string filter = default(string), string expand = default(string), string custom = default(string))
            {
                return Task.Factory.StartNew(s => ((IARQueryOperations)s).PutEntityAsync(entity, select, filter, expand, custom), operations, CancellationToken.None, TaskCreationOptions.None, TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
