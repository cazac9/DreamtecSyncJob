...
namespace DreamtecSyncJob.Acumatica
{
    ...
    /// </summary>
    public partial interface IAPQueryModifiedOperations
    {
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object,APQueryModifiedPutFileHeaders>> PutFileWithHttpMessagesAsync(IList<string> ids, string filename, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
