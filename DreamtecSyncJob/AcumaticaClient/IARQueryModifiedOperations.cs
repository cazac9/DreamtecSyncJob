...
namespace DreamtecSyncJob.Acumatica
{
    ...
    /// </summary>
    public partial interface IARQueryModifiedOperations
    {
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object,ARQueryModifiedPutFileHeaders>> PutFileWithHttpMessagesAsync(IList<string> ids, string filename, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
