...
namespace DreamtecSyncJob.Acumatica
{
    ...
    /// </summary>
    public partial interface IARQueryOperations
    {
        /// <summary>
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<object,ARQueryPutFileHeaders>> PutFileWithHttpMessagesAsync(IList<string> ids, string filename, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
